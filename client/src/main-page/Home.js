        ...
        <footer className="footer">
          <div className="footer-content">
            <div className="footer-contact">
              ...
              <p className="footer-email">Email: <a href="mailto:info@5kgeneralhospital.com">info@5kgeneralhospital.com</a></p>
            </div>
            <p className="footer-copywrite">© 2024 5 Kilo General Hospital. All rights reserved.</p>
          </div>
        </footer>
      </div>
